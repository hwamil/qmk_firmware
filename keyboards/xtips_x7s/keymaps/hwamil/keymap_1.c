...
// Hyper+Nav Layer for window manager shortcuts
 void td_vhyprnav_finished(tap_dance_state_t *state, void *user_data) {
    if (state->pressed) {
        // Key is held down
...
void td_vhyprnav_reset(tap_dance_state_t *state, void *user_data) {
    if (state->pressed) {
        // Key was held; clean up modifiers and layer
 ...
 void td_mhyprnav_finished(tap_dance_state_t *state, void *user_data) {
    if (state->pressed) {
        // Key is held down
        register_code(KC_LCTL);
        register_code(KC_LALT);
...
void td_mhyprnav_reset(tap_dance_state_t *state, void *user_data) {
    if (state->pressed) {
        // Key was held; clean up modifiers and layer
        unregister_code(KC_LCTL);
        unregister_code(KC_LALT);
...
tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_VHYPR_NAV] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, td_vhyprnav_finished, td_vhyprnav_reset),
    [TD_MHYPR_NAV] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, td_mhyprnav_finished, td_mhyprnav_reset),
};
...
//    ├───────────┼───────────┼────────────┼──────────────────┼────────────┼────────────┼──────────────────┼────────────┼───────────┼─────────────────────┤
//    │     z     │ ALGR_T(x) │     c      │ TD(TD_VHYPR_NAV) │ HYPR_T(b)  │ HYPR_T(k)  │ TD(TD_MHYPR_NAV) │     ,      │ ALGR_T(.) │          /          │
//    ├───────────┼───────────┼────────────┼──────────────────┼────────────┼────────────┼──────────────────┼────────────┼───────────┼─────────────────────┤
//    │    no     │    no     │ LT(3, esc) │    LT(1, spc)    │ LT(2, tab) │ LT(5, ent) │   LT(4, bspc)    │ LT(6, del) │    no     │         no          │
//    └───────────┴───────────┴────────────┴──────────────────┴────────────┴────────────┴──────────────────┴────────────┴───────────┴─────────────────────┘
[0] = LAYOUT(
  ...
  KC_Z         , ALGR_T(KC_X) , KC_C          , TD(TD_VHYPR_NAV) , HYPR_T(KC_B)  , HYPR_T(KC_K)  , TD(TD_MHYPR_NAV) , KC_COMM       , ALGR_T(KC_DOT) , KC_SLSH            ,
